# sBotics Syntaxe To Kate Editor
**INSTRUÇÕES PARA GERAR OS ARQUIVOS DE SINTAXE PARA O EDITOR KATE - SYNTAX HIGHLIGHTING**\
(INSTRUCTION TO GENERATE SYNTAX FILES FOR KATE EDITOR - SYNTAX HIGHLIGHTING)

**BAIXANDO O EDITOR KATE, PYTHON3 E PIP**\
...
[Clique aqui para baixar o Python3/Click here to download Python3](https://www.python.org/downloads/)\
[Clique aqui para baixar o PIP/Click here to download PIP](https://pip.pypa.io/en/stable/installing/)
...
2. Have python3 and pip installed
